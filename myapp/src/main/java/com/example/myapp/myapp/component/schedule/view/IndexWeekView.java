package com.example.myapp.myapp.component.schedule.view;
...
//
//            canvas.drawText(calendar.getScheme(), x + mItemWidth - mPadding - 16, mPadding + 16, mCurMonthLunarTextPaint);
        } else {
            canvas.drawText(String.valueOf(calendar.getDay()), cx, mTextBaseLine + top,
                    calendar.isCurrentDay() ? mCurDayTextPaint :
